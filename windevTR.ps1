...
$translations = @{
    ...
    '"Content": "Remove Widgets"'                        = '"Content": "Widget\'ları Kaldır"'
    ...
    '"Content": "Remove Gallery from Explorer"' = '"Content": "Gezgin\'den Galeriyi Kaldır"'
    '"Content": "Remove Home from Explorer"' = '"Content": "Gezgin\'den Ana Sayfa Kaldır"'
